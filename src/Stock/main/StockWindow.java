...
public class StockWindow extends JPanel{
    ...
    private ImageIcon Stock1Image, Stock2Image, Stock3Image, Stock4Image;
    private Timer timer;
    ...
    public StockWindow(Main mainFrame, House house)
    {
        ...
        Stock1Image = new ImageIcon("data/Stock/image/"+STOCK[0]+".png");
        ...
        Stock2Image = new ImageIcon("data/Stock/image/"+STOCK[1]+".png");
        ...
        Stock3Image = new ImageIcon("data/Stock/image/"+STOCK[2]+".png");
        ...
        Stock4Image = new ImageIcon("data/Stock/image/"+STOCK[3]+".png");
    ...
    public void resetall(){
        ...
        ImageIcon temp = new ImageIcon("data/Stock/Stock"+select+".png");
